...
namespace SendPacket
{
    ...
    bool CharSkillErase(ClientNet::CClientEventHandler* lpHandler, unsigned long CharID_In, unsigned short SkillID_In, unsigned char Index_In, Item::ItemPos* lpItem_In);
