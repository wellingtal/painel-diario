...
CRYLLongDefenceWeaponControl::CRYLLongDefenceWeaponControl( CCharacterControl* lpObjControl ) 
{
...
CRYLLongDefenceWeaponControl::~CRYLLongDefenceWeaponControl() 
{
}

//--------------------------------------------------------------------------------------------------------------------------
// CRYLLongDefenceWeaponControl::SetModifySkileton()
VOID        CRYLLongDefenceWeaponControl::SetModifySkileton() 
{
...
//--------------------------------------------------------------------------------------------------------------------------
// CRYLLongDefenceWeaponControl::UpdateControl()
HRESULT		CRYLLongDefenceWeaponControl::UpdateControl( BOOL bKeyAble, BOOL bEdge, int MouseX,int MouseY ) 
{
...
//--------------------------------------------------------------------------------------------------------------------------
// CRYLLongDefenceWeaponControl::MakeAttackInfo()
bool CRYLLongDefenceWeaponControl::MakeAttackInfo( unsigned short wSkill, unsigned char cSkillLock, unsigned char cSkillLevel, 
									      unsigned char cAtCount, float fAttackAngle, float fAttackRate, BOOL bAngle, BOOL bGod )
{
	...
	{
		//CNetwork::SendCharAttack(pCreature.m_vecPos, pCreature.m_fDirection - FLOAT_PHI / 2.0f, 0, a, &AtList);
		//AtNode AtList;
...
//--------------------------------------------------------------------------------------------------------------------------
// CRYLLongDefenceWeaponControl::MakeSkillAttackInfo()
bool CRYLLongDefenceWeaponControl::MakeSkillAttackInfo( unsigned long dwTargetID, unsigned short wSkill, 
...
//--------------------------------------------------------------------------------------------------------------------------
// CRYLLongDefenceWeaponControl::SetSiegeModel()
VOID        CRYLLongDefenceWeaponControl::SetSiegeModel( unsigned long dwChrID, const char *strName, vector3 vecChrPos, float fDirection ) 
{
    m_lpSiegeModel = RYLCreatureManager::Instance()->AddSiegeCreature( m_lpSiegeModel, dwChrID, strName, vecChrPos, fDirection, "LongCastleWeapon" );
}

//--------------------------------------------------------------------------------------------------------------------------
// CRYLLongDefenceWeaponControl::SetCamera()
VOID		CRYLLongDefenceWeaponControl::SetCamera( int dx, int dy, int dz )
{	
    RYLCreature* pSelfCreature = RYLCreatureManager::Instance()->GetSelfCreature();
    if ( !pSelfCreature )
        return;
