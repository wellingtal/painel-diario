...
:	CRYLInventoryPanel( pParentDlg )
{
	...
	CRYLSpriteList::Instance()->CreateGMImage( 375, /*442*/632, &pImageDIB ) ; // was 320, 442 // inventory mod
	pImageDIB->ClearbyColor( 0x00000000 ) ;
	SetRect( &rt, 0, 0, 375, 256 ) ; // was 0, 0, 320, 256
	pImageDIB->DrawRect( &rt, 0, 0, CRYLSpriteList::Instance()->FindSprite( ERYLSPRITENAME::RYL_INVEN_HUMAN01_256x256 ) ) ;
	SetRect( &rt, 0, 0, 375, /*185*/375 ) ; // was 0, 0, 320, 185  // inventory mod
	...
	GM_DELETE( pImageDIB ) ;
	SetWidth( 375 ) ; // was 320
	SetHeight( /*440*/630 ) ; // was 440  // inventory mod
...
VOID	CRYLHumanInventoryPanel::InitCtrl() 
{
	...
	m_pWeaponButton[ 0 ]->SetLeft( 18 ) ; // was 18
	m_pWeaponButton[ 0 ]->SetTop( 65 ) ; // was 65
	...
	m_pWeaponButton[ 1 ]->SetLeft( 45 ) ; // was 45
	m_pWeaponButton[ 1 ]->SetTop( 65 ) ; // was 65
	...
	m_pShieldButton[ 0 ]->SetLeft( 185 ) ; // was 184
	m_pShieldButton[ 0 ]->SetTop( 65 ) ; // was 65
	...
	m_pShieldButton[ 1 ]->SetLeft( 211 ) ; // was 211
	m_pShieldButton[ 1 ]->SetTop( 65 ) ; // was 65
	...
	m_pArmorButton[ 0 ]->SetLeft( 88 ) ; // was 88
	m_pArmorButton[ 0 ]->SetTop( 65 ) ; // was 65
	...
	m_pArmorButton[ 1 ]->SetLeft( 115 ) ; // was 115
	m_pArmorButton[ 1 ]->SetTop( 65 ) ;  // was 65
	...
	m_pArmorButton[ 2 ]->SetLeft( 141 ) ; // was 141
	m_pArmorButton[ 2 ]->SetTop( 65 ) ; // was 65
	...
	m_pInvenButton[ 0 ]->SetLeft( 6 ) ; //was 193 // inventorymod
	m_pInvenButton[ 0 ]->SetTop( 251 ) ; // was 251
	...
	m_pInvenButton[ 1 ]->SetLeft( 6 ) ; // was 193  // inventorymod
	m_pInvenButton[ 1 ]->SetTop( 290 ) ;  // was 290
	...
	m_pInvenButton[ 2 ]->SetLeft( 6 ) ; // was 193 // inventorymod
	m_pInvenButton[ 2 ]->SetTop( 329 ) ; // was 329
	...
	m_pInvenButton[ 3 ]->SetLeft( 6 ) ; // was 193 // inventorymod
	m_pInvenButton[ 3 ]->SetTop( 368 ) ; // was 368
	...
	m_pStreetStallButton->SetLeft( 155 ) ; // was 164
	m_pStreetStallButton->SetTop( 27 ) ; // was 27
	...
	m_pCurrentGoldLabel->SetLeft( 65 ) ; // was 61
	m_pCurrentGoldLabel->SetTop( /*419*/600 ) ; // was 419   // inventorymod
	m_pCurrentGoldLabel->SetFontColor( 0xffffffff ) ;
	m_pCurrentGoldLabel->SetAutoSize( TRUE ) ;
	SetRect( &rt, 65, /*419*/599, 193, /*430*/610 ) ; // inventorymod // was 61,419,193,430
	...
	// Avalansa new stats add STR
	m_pSTRLabel = new CRYLLabel( m_pGMUIParentDlg ) ;
	m_pSTRLabel->SetLeft( 300 ); // was 136
	...
	// Avalansa new stats add DEX
	m_pDEXLabel = new CRYLLabel( m_pGMUIParentDlg ) ;
	m_pDEXLabel->SetLeft( 300 ); // was 136
...
/*
	...
	m_pExperienceLabel->SetLeft( 239 ); 
	m_pExperienceLabel->SetTop( 166 );
	m_pExperienceLabel->SetFontColor (0xffffffff);
	m_pExperienceLabel->SetAutoSize( TRUE ) ;
	m_pExperienceLabel->SetTooltip( &m_pGMUIParentDlg->m_TooltipManager, CRYLStringTable::m_strString[ 4706 ], 1861, TOOLTIP_PANEL ) ;	
	CGMUICustomPanel::AddChild( m_pExperienceLabel ) ;

	// EXPERIENCE VALUE
	m_pExperienceBalueLabel = new CRYLLabel( m_pGMUIParentDlg ) ;
	m_pExperienceBalueLabel->SetLeft( 239 ); 
	m_pExperienceBalueLabel->SetTop( 166 );
	m_pExperienceBalueLabel->SetFontColor (0xffffffff);
	m_pExperienceBalueLabel->SetAutoSize( TRUE ) ;
	m_pExperienceBalueLabel->SetTooltip( &m_pGMUIParentDlg->m_TooltipManager, CRYLStringTable::m_strString[ 4706 ], 1861, TOOLTIP_PANEL ) ;	
	...
	m_pClassLabel->SetLeft( 122 );
	m_pClassLabel->SetTop( 121 );
	m_pClassLabel->SetFontColor (0xffffffff);
	m_pClassLabel->SetAutoSize( TRUE ) ;
	m_pClassLabel->SetTooltip( &m_pGMUIParentDlg->m_TooltipManager, CRYLStringTable::m_strString[ 4706 ], 1861, TOOLTIP_PANEL ) ;	
	CGMUICustomPanel::AddChild( m_pClassLabel ) ;

	// GUILD
	m_pGuildLabel = new CRYLLabel( m_pGMUIParentDlg ) ;
	m_pGuildLabel->SetLeft( 122 ); 
	m_pGuildLabel->SetTop( 141 );
	m_pGuildLabel->SetFontColor (0xffffffff);
	m_pGuildLabel->SetAutoSize( TRUE ) ;
	m_pGuildLabel->SetTooltip( &m_pGMUIParentDlg->m_TooltipManager, CRYLStringTable::m_strString[ 4706 ], 1861, TOOLTIP_PANEL ) ;	
	CGMUICustomPanel::AddChild( m_pGuildLabel ) ;

	// NATION
	m_pNationLabel = new CRYLLabel( m_pGMUIParentDlg ) ;
	m_pNationLabel->SetLeft( 122 ); 
	m_pNationLabel->SetTop( 202 );
	m_pNationLabel->SetFontColor (0xffffffff);
	m_pNationLabel->SetAutoSize( TRUE ) ;
	m_pNationLabel->SetTooltip( &m_pGMUIParentDlg->m_TooltipManager, CRYLStringTable::m_strString[ 4706 ], 1861, TOOLTIP_PANEL ) ;	
	CGMUICustomPanel::AddChild( m_pNationLabel ) ;

	// LEVEL
	m_pLevelLabel = new CRYLLabel( m_pGMUIParentDlg ) ;
	m_pLevelLabel->SetLeft( 122 ); 
	m_pLevelLabel->SetTop( 223 );
	m_pLevelLabel->SetFontColor (0xffffffff);
	m_pLevelLabel->SetAutoSize( TRUE ) ;
	m_pLevelLabel->SetTooltip( &m_pGMUIParentDlg->m_TooltipManager, CRYLStringTable::m_strString[ 4706 ], 1861, TOOLTIP_PANEL ) ;	
...
HRESULT		CRYLHumanInventoryPanel::FinalRender( LPDIRECT3DDEVICE8 lpD3DDevice ) 
{
	...
	if (pGame->m_lpPickItem && g_MessageBoxManager.m_lstMessageBox.empty())
	{
		...
		else if (g_DeviceInput.InRect(m_pGMUIParentDlg->GetLeft() + 38, m_pGMUIParentDlg->GetTop() + 290, m_pGMUIParentDlg->GetLeft() + /*193*/245, m_pGMUIParentDlg->GetTop() + /*445*/627))		// inventory mod !!	
		{
			...
			{
				if (pGame->m_lpPickItem->GetItemInfo().m_DetailData.m_cXSize + pItemIndex.GetXIndex() <= /*6*/13 &&  // inventory mod !!!!!!!!
					pGame->m_lpPickItem->GetItemInfo().m_DetailData.m_cYSize + pItemIndex.GetYIndex() <= /*6*/8)   // inventory mod !!!!!!!!
				{
					pGame->RenderRect(lpD3DDevice,
						m_pGMUIParentDlg->GetLeft() + 38 + pItemIndex.GetXIndex() * 26, m_pGMUIParentDlg->GetTop() + 290 + pItemIndex.GetYIndex() * 26,
						m_pGMUIParentDlg->GetLeft() + 38 + pGame->m_lpPickItem->GetItemInfo().m_DetailData.m_cXSize * 26 + pItemIndex.GetXIndex() * 26,
...
VOID CRYLHumanInventoryPanel::SetTipString()
{
