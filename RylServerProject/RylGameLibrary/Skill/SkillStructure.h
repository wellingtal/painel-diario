...
namespace Skill
{
	...
	namespace Type 
	{
		enum AbilityType
		{
			...
			AB_SOCIALEX			= 1,	//
			AB_NOFIRSTATK		= 2,	//
			AB_MOUNT_SPEEDUP	= 3,	// Trained Rider
			AB_TEMPINVEN_TIMEUP = 4,	//
			AB_GETUP_GOLD		= 5,	// Master Thief
			AB_RESPAWN_EX		= 6,	// Explorer
			AB_FOOD_UP			= 7,	// Iron Stomach
			AB_SHOP_MEMBERSHIP	= 8,	//
			AB_CHEMICAL			= 9,	// Chemical
			AB_ENDUR_SHILD		= 10,	//
			AB_RECOVERY_UP		= 11,	//
			AB_GATHER_FIND		= 12,	//
			AB_MYEQUIP_UP		= 13,	//
			AB_LUCK_UP			= 14,	//
			AB_EQUIP_LEVELDOWN	= 15,	//
			AB_HERBS			= 16,	// Herb Collector
			AB_MINING			= 17,	// Miner
			MAX_ABILITY_TYPE	= 18
		};
