...
// test avalansa
//bool ReadAddStr(Item::ItemInfo& itemInfo, const char* szValue)		    { ++itemInfo.m_EquipAttribute.m_nAttibuteNum; return ReadValue(itemInfo.m_EquipAttribute.m_usAttributeValue[Item::Attribute::ADD_STR], szValue);		}
...
//	parseDataArray.push_back(ParseData("Darkness",				ReadDarkness));
	...
	// test avalansa
//	parseDataArray.push_back(ParseData("ADD_STR",				ReadAddStr));
