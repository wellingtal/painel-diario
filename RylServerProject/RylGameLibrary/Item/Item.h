...
namespace Item
{
    ...
    public:
		...
		inline unsigned short	GetItemType(void)						{ return m_ItemData.m_ItemPos.m_cIndex;		}//hayzohar added for check if the item is TUNIC or SHIRT
    ...
    public:
		...
		void			SetSocketNum(int socket){m_cMaxSocket=socket;};
    ...
    protected:
		...
		unsigned char		m_cCoreLevel;		// 코어레벨
