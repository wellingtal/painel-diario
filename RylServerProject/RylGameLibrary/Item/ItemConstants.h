...
namespace Item
{
	...
	enum Const
	{
		...
		MAX_TEMP_INVEN_ITEM_NUM		= 50,		// 임시 인벤토리에 넣을 수 있는 최대 아이템 갯수 // was 20
    ...
    namespace EtcItemID
    {
        ...
        {
            // 보석 아이템 ID
            GEM_START_ID            = 1901,//was 1901 hayzohar gem star
            GEM_END_ID              = 1915,
